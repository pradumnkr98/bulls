...
export declare type LoadingOverLayProps = {
     ...
     * @type {Styles}
     */
    styles?: Record<StyleKeys, Styles[StyleKeys] | CSSInterpolation | TemplateStringsArray>;
    /**
     *
     *
     * @type {ReactNode}
...
export declare type OverflowCSS = {
    overflow: CSSProperties['overflow'];
    overflowX: CSSProperties['overflowX'];
    overflowY: CSSProperties['overflowY'];
};
export declare type LoadingOverlayState = {
    overflowCSS?: OverflowCSS;
};
export declare type LoadingOverlayDefaultProps = {
    classNamePrefix: string;
    fadeSpeed: number;
    styles: {};
};
